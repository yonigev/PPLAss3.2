...
export const getFBindingVal = (f: FBinding): Value4 | Thunk => unbox(f.val);
...
const frameVals = (frame: Frame): (Value4| Thunk)[] => map(getFBindingVal, frame.fbindings);
...
*/
export const applyEnv = (env: Env, v: string): Value4| Thunk | Error => {
